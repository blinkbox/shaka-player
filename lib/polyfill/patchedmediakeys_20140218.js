...
shaka.polyfill.PatchedMediaKeys.v20140218.install = function() {
    ...
    window.MediaKeyError = v20140218.MediaKeyError;
...
-------------------------------------------------------------
    ...
    Everything below this point is copy/past from v01b
    implementation; TODO - move to common implementation?
