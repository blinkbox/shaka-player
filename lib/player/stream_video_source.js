...
shaka.player.StreamVideoSource.prototype.configure = function(config) {
  ...
  if (config['rangeRequestTimeout'] != null) {
    this.streamConfig_['rangeRequestTimeout'] =
        config['rangeRequestTimeout'];
  }
...
shaka.player.StreamVideoSource.prototype.beginPlayback_ = function(
  ...
  // as necessary. If |maxTimestampCorrection_| is 0 then don't modify
  ...
  if (this.maxTimestampCorrection_ != 0) {
    shaka.log.debug(
