 ...
 *   of the playhead, in seconds, after stream startup. Where stream startup
 *   entails acquiring some initial resources for each stream. For DASH audio
 *   and video streams, startup completes when each stream buffers N seconds of
 *   content, where N equals the 'minBufferTime' attribute from the MPD.
 *
 * <li>
 ...
 *
 * <li>
 *   segmentRequestTimeout: number <br>
 ...
 *
 * <li>
 *   restrictions: shaka.player.Restrictions <br>
